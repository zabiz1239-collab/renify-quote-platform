...
Invoke `/repository-moderniser` when available. Before editing application files, read the existing applicable instructions and documentation, then read `.repo-moderniser/START_HERE.md`, `.repo-moderniser/moderniser.yml`, `.repo-moderniser/ORCHESTRATOR.md`, and the numbered playbooks.
